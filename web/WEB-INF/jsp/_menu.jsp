...
<div id="menu" class="container">
    <ul>
        <li class="current_page_item"><a href="#" accesskey="1" title=""><fmt:message key="header_jsp.menu.client.homepage"/></a></li>
        <li><a href="#" accesskey="1" title=""><fmt:message key="header_jsp.menu.client.about_us"/></a></li>
        ...
        <li><a href="#" accesskey="5" title=""><fmt:message key="header_jsp.menu.client.contact_us"/></a></li>
    </ul>
</div>