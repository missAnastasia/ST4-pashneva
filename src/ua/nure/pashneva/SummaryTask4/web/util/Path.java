...
public class Path {
    ...
    public static final String COMMAND_MESSAGE_SUCCESS = "controller?command=getSuccessPageCommand&message=";
    public static final String COMMAND_MESSAGE_ERROR = "controller?command=getErrorPageCommand&message=";
